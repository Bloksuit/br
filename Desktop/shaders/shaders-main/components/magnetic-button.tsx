...
export function MagneticButton({
  ...
  const variants = {
    ...
    secondary:
      "bg-foreground/5 text-black hover:bg-foreground/10 backdrop-blur-xl border border-foreground/10 hover:border-foreground/20",
    ghost: "bg-transparent text-black hover:bg-foreground/5 backdrop-blur-sm",
  }
